...
export default function CadastroScreen({ navigation }) {
    ...
    const especialidades = [
        "Clínico Geral", "Pediatra", "Ginecologista", "Cardiologista",
        "Dermatologista", "Neurologista", "Psiquiatra", "Oftalmologista",
        "Otorrinolaringologista", "Endocrinologista", "Gastroenterologista",
        "Nefrologista", "Reumatologista", "Infectologista", "Médico de Família",
        "Urologista", "Alergologista", "Pneumologista", "Nutrólogo", "Homeopata"
    ];
        ...
        <ScrollView contentContainerStyle={styles.scrollContainer}>
            <View style={styles.container}>
                <View style={styles.formBox}>
                        ...
                        {userTypes.map((item) => (
                            <TouchableOpacity
                                ...
                                onPress={() => {
                                    ...
                                    if (item.value === "paciente") {
                                        handleInputChange("area", "");
                                        handleInputChange("crm", "");
                                    }
                                }}
                            >
                                <View
                    ...
                    >
                        <Text style={{ color: "#2e7d32" }}>Já tem uma conta? Faça login</Text>
                    </TouchableOpacity>
                </View>
            </View>
        </ScrollView>
